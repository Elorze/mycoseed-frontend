<template>
  <div class="min-h-screen pb-24">
    <div class="w-full max-w-2xl mx-auto px-4 py-8">
      <PixelCard>
        <template #header>
          <div class="text-center font-pixel text-xl text-mario-red">设置社区信息</div>
        </template>

        <div class="flex flex-col gap-6 py-4">
          <!-- 头像上传 -->
          <div class="space-y-4">
            <label class="block font-pixel text-xs uppercase text-gray-600">社区头像</label>
          ...
          <!-- 社区名称输入 -->
          <div class="space-y-2">
            <label class="block font-pixel text-xs uppercase text-gray-600">社区名称 *</label>
            <input
          ...
          <!-- 社区简介输入 -->
          <div class="space-y-2">
            <label class="block font-pixel text-xs uppercase text-gray-600">社区简介</label>
            <textarea
...
const { updateCommunityProfile, getMe } = useApi()
